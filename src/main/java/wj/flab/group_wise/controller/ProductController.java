...
import wj.flab.group_wise.dto.product.request.SaleStatusUpdateRequest;
...
public class ProductController {
    ...
    public ResponseEntity<Void> updateSaleStatus(
        @PathVariable("productId") long productId,
        @RequestBody SaleStatusUpdateRequest statusUpdateRequest) {

        productService.updateProductSaleStatus(productId, statusUpdateRequest.saleStatus());
        return ResponseEntity.ok().build();
    }
